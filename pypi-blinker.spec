...
Source0  : https://files.pythonhosted.org/packages/1e/57/a6a1721eff09598fb01f3c7cda070c1b6a0f12d63c83236edf79a440abcc/blinker-1.8.2.tar.gz
...
%prep
%setup -q -n blinker-1.8.2
cd %{_builddir}/blinker-1.8.2
pushd ..
cp -a blinker-1.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715028935
